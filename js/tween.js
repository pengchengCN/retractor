...
//默认以减速的效果
//然后再分别用5个数字来表示五种常用的动画效果
//0减速，1匀速，2Elastic,3back,4bounce

//如果我们想让动画有更多的效果，还可以用一个length为2的数组来“组合”
//比如说给第四个参数传一个["zfBounce","easeIn"]的数组，则组合出zhufengEffect["zfBounce"]["easeIn"]这样的一组效果来
